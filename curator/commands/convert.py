...
def convert_main(argv: Optional[List[str]] = None):
    ...
    from ..utils import convert_mace_to_curator, upgrade_checkpoint
    ...
    if args.update:
        ...
        from ..utils import convert_cueq_to_e3nn, convert_e3nn_to_cueq, load_models
        ...
        from ..utils import convert_curator_to_mace, convert_mace_to_curator
