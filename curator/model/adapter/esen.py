...
class ESENAdapter(nn.Module):
    ...
    def _to_fairchem_frame_fallback(self, struct: BatchStructure):
        ...
        atoms = Atoms(
            ...
            cell=None if struct.cell is None else struct.cell.detach().cpu().numpy(),
    ...
    def _build_batch(self, data):
        ...
        for struct in split_batch_structures(data):
            if struct.edge_index is not None and (struct.cell is None or struct.edge_diff is not None or struct.cell_displacements is not None):
