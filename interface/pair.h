...
class Pair : protected Pointers {
 ...
 public:
  ...
  double e_var;            // energy variance     only for pair_painn
  double e_sd;             // energy standard deviation     only for pair_painn
  double f_var;            // force variance      only for pair_painn
  double f_sd;             // force standard deviation       only for pair_painn
